...
var Gesture = function () {
  ...
  _createClass(Gesture, [{
    ...
    value: function touchmove(evt) {
      ...
      var distance = getDistance(this.startTouch.clientX, this.startTouch.clientX, touch.clientX, touch.clientX);
    ...
    value: function touchend(evt) {
      ...
      var time = Date.now();
      var distance = getDistance(this.startTouch.clientX, this.startTouch.clientX, this.endTouch.clientX, this.endTouch.clientX);
