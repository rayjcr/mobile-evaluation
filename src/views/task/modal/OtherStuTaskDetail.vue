    ...
    <div class="popup">
      ...
      <div class="popup-info border-bottom">
        <p class="content">{{info.content}}</p>
          <div class="imglist clear scrollY" v-if="info.fileInfoVOS.length > 0">
            <div class="img fl a" v-for="(item,index) in info.fileInfoVOS" :key="item.absolutePath+index"><img v-gallery:group10 :src="item.absolutePath"></div>
          </div>
      </div>
      <div class="popup-bottom">
        <div class="notps" v-if="info.status == 0">未审核</div>
        <div class="pass-box" v-else-if="info.status == 1">
