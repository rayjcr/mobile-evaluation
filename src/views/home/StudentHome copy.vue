...
<script>
  ...
  import {weixinAPi,scanExchangeApi,userInfoAPi,scanLoginApi} from '@/utils/api'
  ...
  export default {
    ...
    mounted() {
      ...
      // var encryptHex = "http://www.91sst.com/centerlogin/QrLogin/Go?qlc=7j9JFVzqaxK6C7u2a8CZ&n=akXtsF&t=1591605966&s=a6ec16b1f13357b485d339b09c359257"
      
      // this.getStudentQRCodeContent(encryptHex)
    },
    activated() {
      // url地址发生改变时需要重新注册
      if (this.getIsWxClient()) {
        console.log("获取微信签名信息url地址发生改变时需要重新注册")
        this.getConfig(); // 获取微信签名信息
      }
    },
    methods: {
