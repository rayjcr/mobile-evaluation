    ...
    methods: {
      ...
      * */
      getConfig() {
        ...
        let origin = this.$route.query.type || this.$cookie.get('origin') || '' // 是否来源于微信公众号 1,公众号；3，企业号
      ...
      **/
      ...
      getIsWxClient() {
        ...
        var origin = this.$route.query.type || this.$cookie.get('origin') || ''; // 是否来源于微信公众号 1,公众号；3，企业号
