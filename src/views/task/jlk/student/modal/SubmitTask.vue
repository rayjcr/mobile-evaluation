    ...
    <div class="popup flex">
      ...
      <div class="popup-content">
        ...
        <div class="flex border">
          <textarea class="flex_1 textarea" placeholder="请输入备注内容" v-model="content" @blur="$blur" maxlength="200"></textarea>
        </div>
        <div class="img-box">
      ...
      <div class="popup-foot flex justifyCenter">
        ...
        <div class="flex_1 btn sure" v-preventReClick="1000"  @click="sure($event)">确定</div>
      </div>
    </div>
    <!--上传图片-->
