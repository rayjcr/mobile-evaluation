  ...
  <div class="header-box">
    ...
    <div class="header-fixed" v-if="!(opacity==0)" :style="{'opacity': opacity >= 1 ? 1 : opacity}">
      <div class="flex alignCenter">
        ...
        <div class="icon-box">
          ...
          <!-- <span class="scan" @click="scan"></span> -->
          <span class="schoolNews" @click="jumpOut"></span>
          <span class="wyrank" @click="selectRankTime"></span>
        </div>        
      </div>
    ...
    <div class="header-bg flex" :style="{'opacity': scrollTop == 0 ? 1 : (1 - opacity) <= 0 ? 0 : (1 - opacity)}">
      <div class="header-left flex_1 text-overflow">
        <div class="name">武义县职业技术学校<br>{{timeZH}}，{{teacherName}}老师</div>
      ...
      <div class="icon-box">
        <span class="rank" v-if="jlk == 'true'" @click="_jump('/ranklist')">榜单</span>
        <span class="schoolNews" @click="jumpOut">学校新闻</span>
        <span class="wyrank" @click="selectRankTime">排行榜</span>
  ...
  export default {
    ...
    methods: {
      ...
      **/
      ...
      sure(a) {
        this.jumpRank(a.xn,a.xq);
      },
      // 跳转到武义榜单
      jumpRank(xn,xq){
        var path = '/wuyi/ranking'
        var query = {
          type: 'teacher',
          schoolYear: xn,
          term: xq
...
<style lang="less" scoped>
  .header-box {
    ...
    .header-bg {
      height: 389px;
      padding: 0 32px;
      background-image: url("./img/wy_header_bg@2x.png");
    ...
    .icon-box {
      ...
      span {
        ...
        &.schoolNews {
          background: url('./img/school_news.png') no-repeat center top;
          background-size: 58px auto;
        }
        &.wyrank {
          background: url('./img/wy_rank.png') no-repeat center top;
          background-size: 58px auto;
        }
      }
    }
    ...
    .banner{
      ...
      width: 722px;
      margin-left: -361px;
      background-image: url(img/wybanner.png);
      background-repeat: no-repeat;
